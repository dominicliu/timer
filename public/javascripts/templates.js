...
function program7(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\r\n		");
  stack1 = helpers['if'].call(depth0, "notification", {hash:{},hashTypes:{},hashContexts:{},inverse:self.program(10, program10, data),fn:self.program(8, program8, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\r\n	");
  return buffer;
  }
function program8(depth0,data) {
  ...
  var buffer = '';
  data.buffer.push("\r\n			<button ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "turnOffNotification", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  data.buffer.push(">don&#39;t notify</button>\r\n		");
  return buffer;
  }
...
function program10(depth0,data) {
  ...
  var buffer = '';
  data.buffer.push("\r\n			<button ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "turnOnNotification", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  data.buffer.push(">notify</button>\r\n		");
  return buffer;
  }
