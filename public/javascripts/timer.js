    ...
    actions: {
      start: function() {
        ...
        if (!this.get("paused")) {
          ...
          Cookies.set("hours", this.get("hours"));
          Cookies.set("minutes", this.get("minutes"));
          Cookies.set("seconds", this.get("seconds"));
        }
        ...
        if (!that.get("notificationGranted")) {
          return Notification.requestPermission(function(permission) {
            if (permission === "granted") {
              ...
              return Cookies.set("notification", true);
      ...
      turnOffNotification: function() {
        ...
        return Cookies.set("notification", false);
      }
    },
